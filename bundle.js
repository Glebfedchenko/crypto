...
var getAllData = exports.getAllData = function getAllData() {
    return function (dispatch) {
        fetch('https://min-api.cryptocompare.com/data/all/coinlist').then(function (res) {
            return res.json();
        }).then(function (data) {
            dispatch({
                type: FETCH_DATA,
...
var getDataFailed = exports.getDataFailed = function getDataFailed() {
    return {
...
var _Coins = __webpack_require__(48);
...
var _Wrapper = __webpack_require__(76);

var _Wrapper2 = _interopRequireDefault(_Wrapper);

var _Coin = __webpack_require__(77);
...
var Coins = function (_Component) {
    ...
    function Coins() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Coins.__proto__ || Object.getPrototypeOf(Coins)).call.apply(_ref, [this].concat(args))), _this), _this.getCoins = function () {
            var coinArray = [];
            var size = 29;
            for (var item in _this.props.coins.data) {
                coinArray.push(_this.props.coins.data[item]);
            }
            return coinArray.slice(9, size).map(function (coin, i) {
                return _react2.default.createElement(_Coin2.default, { key: coin.Id,
                    name: coin.Name,
                    i: i,
                    url: coin.Url,
                    image: coin.ImageUrl });
    ...
    _createClass(Coins, [{
        ...
        value: function render() {
            var isFetching = this.props.coins.isFetching;
            return _react2.default.createElement(
                'div',
                { className: 'container text-center' },
                _react2.default.createElement(_Wrapper2.default, null),
                isFetching ? this.getCoins() : _react2.default.createElement(_Spinner2.default, null)
            );
        }
    }]);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        getAllData: (0, _redux.bindActionCreators)(_index.getAllData, dispatch)
    };
};
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(24), __webpack_require__(67)(module)))
...
var Wrapper = function Wrapper() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            "div",
            { className: "col-md-4 col-xs-12 col-lg-4 col-sm-4" },
            _react2.default.createElement(
                "b",
                null,
                "#"
...
var Coin = function Coin(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            "div",
            { className: "col-md-4 col-sm-4 col-xs-12 col-lg-4" },
            i + 1
        ),
        _react2.default.createElement(
            "div",
            ...
            _react2.default.createElement(
                "a",
                { href: "" + BASE_URL + url },
                _react2.default.createElement("img", { className: "img-responsive", src: "" + BASE_URL + image })
            )
        ),
        _react2.default.createElement(
            "div",
...
var Spinner = function Spinner() {
    return _react2.default.createElement(
        "div",
        { className: "loader loader--style3", title: "2" },
        _react2.default.createElement(
            "svg",
            { version: "1.1", id: "loader-1",
...
var _reduxDevtoolsExtension = __webpack_require__(82);
...
var store = (0, _redux.createStore)(_index2.default, (0, _reduxDevtoolsExtension.composeWithDevTools)(enhancer));
...
var _coinReducer = __webpack_require__(81);

var _coinReducer2 = _interopRequireDefault(_coinReducer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var reducer = (0, _redux.combineReducers)({
    coins: _coinReducer2.default
});
...
function coinReducer() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
    var action = arguments[1];

    switch (action.type) {
        case _index.FETCH_DATA:
            return _extends({}, state, {
                data: action.payload,
                isFetching: true
            });
        case _index.FETCH_FAILED:
            {
                return _extends({}, state, {
                    isFetching: false,
